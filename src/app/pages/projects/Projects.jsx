    ...
    return (
        <div className="z-[10] relative pt-28 pb-10">
            ...
            <div className=" mt-10 flex flex-wrap items-center justify-center gap-14 py-10 lg:px-40">
                <div data-aos="zoom-out-right" className=" 2xl:w-[47%] sm:w-[45%] relative group cursor-pointer ">
                    ...
                    <div className="absolute left-0 top-0 h-full w-full flex flex-col items-center  justify-start 2xl:pt-28 xl:pt-20 pt-12">
                        <h1 className=" xl:text-xl text-lg font-medium text-white mt-[-10%] z-[12] relative group-hover:mt-[0%]  group-hover:opacity-100 opacity-0 group-hover:visible invisible transition-all ease-linear duration-200">Learning Managment Application</h1>
                ...
                <div data-aos="zoom-out-left" className=" 2xl:w-[47%] sm:w-[45%] relative group cursor-pointer ">
                    <div className="rounded-xl overflow-hidden">
                    ...
                    <div className="absolute left-0 top-0 h-full w-full flex flex-col items-center  justify-start 2xl:pt-28 xl:pt-20 pt-12">
                        ...
                        <div className=" absolute transition-all ease-linear duration-200 invisible group-hover:visible bottom-10 group-hover:bottom-8 left-0 w-full group-hover:opacity-100 opacity-0  z-[10]">
                            <div className=" h-32 overflow-hidden rounded-b-lg w-full z-[10] relative">
                                <Image src={project2} alt="project1" className=" absolute top-10 w-1/2 -rotate-12" />
                                <Image src={project2} alt="project1" className="absolute right-0   top-10 w-1/2 rotate-12" />
                            </div>
                        </div>
                    </div>
                ...
                <div data-aos="zoom-out-up" className=" 2xl:w-[47%] sm:w-[45%] relative group cursor-pointer ">
                    ...
                    <div className="absolute left-0 top-0 h-full w-full flex flex-col items-center  justify-start 2xl:pt-28 xl:pt-20 pt-12">
                        ...
                        <div className=" absolute transition-all ease-linear duration-200 invisible group-hover:visible bottom-10 group-hover:bottom-8 left-0 w-full group-hover:opacity-100 opacity-0  z-[10]">
                            <div className=" h-32 overflow-hidden rounded-b-lg w-full z-[10] relative">
                                <Image src={project3} alt="project1" className=" absolute top-10 w-1/2 -rotate-12" />
                                <Image src={project3} alt="project1" className="absolute right-0   top-10 w-1/2 rotate-12" />
                            </div>
                        </div>
                    </div>
