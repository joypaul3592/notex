    ...
    return (
        <div className="  sm:pt-28 pt-20 pb-16">
            ...
            <div className=' relative 	'>
                <Image data-aos="fade-right" src={element2} alt='element1' className='  2xl:w-40 sm:w-32 w-20 absolute 2xl:-top-24 sm:-top-28 -top-[4.5rem]' />
                <Image data-aos="fade-left" src={element3} alt='element1' className=' lg:w-32 w-20 absolute lg:top-28 sm:top-[8.5rem] top-[80%] lg:right-32 sm:right-40 right-12' />
