...
export default function ServiceCard({ service }) {
    return (
        <div data-aos="zoom-in" className="h-96 w-full border transition-all ease-linear duration-300 cursor-pointer border-lime-400 text-white flex flex-col items-center justify-around group pt-12 relative overflow-hidden">
